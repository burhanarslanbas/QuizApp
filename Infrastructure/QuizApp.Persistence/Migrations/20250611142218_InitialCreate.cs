        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    MaxQuestions = table.Column<int>(type: "int", nullable: false, defaultValue: 10),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuestionRepos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QuestionRepos_AspNetUsers_CreatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShowResults = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    QuestionRepoId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderIndex = table.Column<byte>(type: "tinyint", nullable: false, defaultValue: (byte)0),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionRepos_CreatorId",
                table: "QuestionRepos",
                column: "CreatorId");

            migrationBuilder.CreateIndex(
                name: "IX_Questions_QuestionRepoId",
                table: "Questions",
